  ...
  return (
    <div className="container">
      <div className="heading">
        <h1>Hi, my name is Jennifer Lindsay</h1>
        <div className="hero">
          <img src="/images/JL_Headshot_Tech.jpeg" />
        </div>
      </div>

      <p>But you can call me Jen.</p>
      ...
      <p>In parallel with my engineering career, I spent more than fifteen years as a freelance opera singer based primarily in the greater Los Angeles area. I also joined the Metropolitan Opera Extra Chorus for multiple seasons, appearing in 30 performances at Lincoln Center in the Grammy-winning production of George Gershwin’s Porgy and Bess. I was honored to receive an official Grammy Certificate recognizing my contribution to the cast album, which won Best Opera Recording at the 2021 Grammy Awards.</p>

      <p>I am currently based in Orange County, California, not far from where I grew up. (No, we don't call it "The O.C." Yes, we do say "behind the Orange Curtain.") Outside of work, I enjoy taking advantage of Southern California’s coastal lifestyle and competing with friends on Duolingo to improve my rudimentary grasp of the French language. Merci de votre visite, et bonne journée!</p>
    </div>
  )
}
