...
const Home = () => {
  ...
  return (
    <div className={classes.root} data-testid="screen-home">
      ...
      <Typography variant="body2" gutterBottom component="div"> I'm a software engineer and tech lead specializing in React Native cross-platform mobile application development and React web development. 
          ...
          My responsibilities also involve coordinating release activities for client projects, managing Agile sprints, and refining feature requests into actionable requirements. I am fluent in JavaScript, React, React Native and English, and I am working to improve my proficiency in Python and French. I also have experience with Jira and AWS Cloud Services, including Cognito, DynamoDB, and AppSync GraphQL.
      </Typography>
      <Typography variant="body2" gutterBottom component="div"> For the better part of the last decade, I have also been a freelance opera singer based primarily in the greater Los Angeles area. 
      ...
      <Typography variant="body2" gutterBottom component="div"> I'm currently based in Orange County, CA, not far from where I grew up. (No, we don't call it "The O.C." Yes, we do say "behind the Orange Curtain.") In my spare time, I like to sew historical costumes and compete with my friends on Duolingo to see who can get the most XP each week. I also enjoy working up a sweat, whether by hiking the local trails or with the Supernatural app on my Oculus Quest VR headset, even though exercise makes my hair extremely frizzy :)</Typography>
      </div>
    </div>
  );
};
